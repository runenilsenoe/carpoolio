...
public record PassengerDto(Guid Id, Guid UserId, string Username, string? Note);
...
internal record CarForPassenger(Guid Id, Guid EventId, Guid DriverUserId, int AvailableSeats, Guid CreatorUserId);
