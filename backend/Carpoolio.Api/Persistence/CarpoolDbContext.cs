...
public sealed class CarMember { public Guid Id { get; set; } public Guid CarId { get; set; } public Guid EventId { get; set; } public Guid UserId { get; set; } public string? Note { get; set; } }
